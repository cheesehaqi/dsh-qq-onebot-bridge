...
export const Config = z.object({
  ...
  allowUsers: z.array(z.number().step(1)).default([]).description('Allowlisted QQ user ids (empty = allow everyone).'),
  allowGroups: z.array(z.number().step(1)).default([]).description('Allowlisted QQ group ids (empty = allow all groups).'),
  ...
  acceptPrivate: z.boolean().default(true).description('Whether to respond to private chats at all.'),
